...
function Footer() {
  return (
    <footer className="bg-green-500 dark:bg-green-800 text-yellow-200 dark:text-gray-200 py-10 px-8 sm:px-12 pb-5 transition-all duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-green-100">
            ...
            <li><Link to="/ourteam" className="hover:text-yellow-300 transition">Our Team</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-green-100">
            <li><Link to="/bodyparts" className="hover:text-yellow-300 transition">Flexibility</Link></li>
            <li><Link to="diseases" className="hover:text-yellow-300 transition">Mental Clarity</Link></li>
            <li><Link to="bodyparts" className="hover:text-yellow-300 transition">Balance</Link></li>
            <li><Link to="bodyparts" className="hover:text-yellow-300 transition">Posture Correction</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-sm">Email: yogahealix@gmail.com</p>
      ...
      <div className="mt-10 border-t border-green-500 pt-4 text-center text-xs text-green-200">
        © {new Date().getFullYear()} Yoga-Healix. All rights reserved. | Breathe. Stretch. Evolve | Crafted with ❤️.
      </div>
    </footer>
  );
}
