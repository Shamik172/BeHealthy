...
export default function YogaCardsByDisease({ selectedBodyPart }) {
  ...
  useEffect(() => {
    const fetchAsanas = async () => {
      const query = selectedBodyPart ? `?disease=${encodeURIComponent(selectedBodyPart)}` : '';
