...
const ResetPassword = () => {
  ...
  const onSubmitEmail = async (e) => {
    e.preventDefault();
    try {
      const { data } = await axios.post(`${backendUrl}/auth/instructor/send-reset-otp`, { email });
      if (data.success) {
  ...
  const onSubmitOtp = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${backendUrl}/auth/instructor/verify-reset-password-otp`, { email, otp: otpValue });
      if (data.success) {
  ...
  const onSubmitNewPassword = async (e) => {
    e.preventDefault();
    try {
      const { data } = await axios.post(`${backendUrl}/auth/instructor/reset-password`, { email, newPassword });
      if (data.success) {
