...
const InstructorLogin = ({ isSignup, toggleForm }) => {
  const { backendUrl, setIsInstructorLoggedIn, getInstructorData ,
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      if (isSignup) {
        ...
        //   `${backendUrl}/auth/instructor/register`,
        //   { name, email, password },
        //   {
        ...
        // const { data } = await axios.post(
        //   `${backendUrl}/auth/instructor/login`,
        //   { email, password },
        //   {
        //     headers: { 'Content-Type': 'application/json' },
        //     withCredentials: true,
